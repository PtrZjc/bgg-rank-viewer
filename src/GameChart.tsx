...
import {lastDayGameDataAtom, topRanksShowedAtom, visibleGameNamesAtom} from "./state.ts";
...
export const GameChart: React.FC = () => {
    ...
    const lastDayGameData = useAtomValue(lastDayGameDataAtom);
    ...
    const endLineLabelsPlugin = {
        ...
        afterDatasetsDraw(chart: any) {
            ...
            chart.data.datasets.forEach((dataset: any) => {
                ...
                const rank = lastDayGameData[dataset.label].rank;
